...
-(void)initData{
     ...
     *  造热门搜索的假数据
     */
    self.historyArr = [NSMutableArray arrayWithObjects:nil];//@"北京",@"上海",@"深圳",@"公寓",@"望京", nil];
    
    self.HotArr = [NSMutableArray arrayWithObjects:@"北京",@"上海",@"深圳",@"公寓望京",@"杭州",@"押一付一",@"一室户",@"好屋", nil];
...
-(void)DWQTagView:(UIView *)dwq fetchWordToTextFiled:(NSString *)KeyWord
{
    ...
    ResaViewController *vc = [[ResaViewController alloc]init];
