...
@interface AYLMyViewController ()<UITableViewDataSource,UITableViewDelegate,UIAlertViewDelegate,UINavigationControllerDelegate, SKStoreProductViewControllerDelegate>{
...
@implementation AYLMyViewController
...
//            }
        ...
        case 5:{
            UIView * view = [self createRow:@"评分" isScreenWidth:YES];
            [cell.contentView addSubview:view];
            break;
        }
    }
