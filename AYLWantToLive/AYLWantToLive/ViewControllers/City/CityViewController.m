...
- (UIView *)blackView{
    if(!_blackView)
    {
        _blackView = [[UIView alloc] initWithFrame:CGRectMake(0, NavigatorHeight, SCREEN_WIDTH, SCREEN_HEIGHT-NavigatorHeight)];
...
- (ResultCityController *)resultController{
    if(!_resultController)
    {
        ...
        _resultController.view.frame = CGRectMake(0, NavigatorHeight, ScreenWidth, ScreenHeight -  NavigatorHeight);
...
- (void)viewDidLoad {
    ...
    _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, NavigatorHeight, SCREEN_WIDTH, SCREEN_HEIGHT-NavigatorHeight) style:UITableViewStylePlain];
